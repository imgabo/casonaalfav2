...
const NuestroProyecto = () => {
    ...
    return (
        ...
        <section className="p-10 h-full w-full mb-20">
            ...
            <div className="flex flex-col xl:flex-row items-center justify-between mt-10 gap-20  w-full h-full">
                <div className="h-full w-full">
                    <img src={proyecto} alt="casa descanso marinos" className="h-full w-full rounded-lg" />
                </div>

                <div className="  h-full w-full xl:w-[70%] flex flex-col justify-start items-center ">
                    ...
                    <div className="w-full  xl:pr-28 mt-4">
                    ...
                    <div className="mt-4 w-full xl:pr-28">
